...
class User extends Component
{
	...
	protected function set_widget_option()
	{
		...
		Redux::set_section($this->opt_name, array(
			...
			'fields' => array(
				...
				array(
					...
					'desc'      =>  esc_html__('Use [iqonic_register_form] Shortcode on a page which you sleceted', 'streamit'),
				),

				array(
					'id'       => 'streamit_signup_icon',
					'type'     => 'select',
					'select2'  => array('containerCssClass' => 'fa'),
					'title'    => esc_html__('SignUp button Icon', 'streamit'),
					'width'     => '100%',
					'class'    => 'font-icons',
					'options'  => $iconArray
				),
				...
				array(
					...
					'desc'      =>  esc_html__('Use [iqonic_login] Shortcode on a page which you sleceted', 'streamit'),
				),

				array(
					'id'        => 'streamit_signin_icon',
					'type'     => 'select',
					'select2'  => array('containerCssClass' => 'fa'),
					'title'    => esc_html__('SignIn button Icon', 'streamit'),
					'width'     => '100%',
					'class'    => ' font-icons',
					'options'  => $iconArray
				),
				...
				array(
					'id'        => 'streamit_logout_icon',
					'type'     => 'select',
					'select2'  => array('containerCssClass' => 'fa'),
					'title'    => esc_html__('Logout Button Icon', 'streamit'),
					'width'     => '100%',
					'class'    => ' font-icons',
					'options'  => $iconArray
				),
				...
				array(
					'id' => 'streamit_profile_section',
					'type' => 'section',
					'title' => esc_html__('Profile', 'streamit'),
					'indent' => true
				),
				array(
					'id'        => 'streamit_profile_title',
					'type'      => 'text',
					'title'     => esc_html__('Profile button title', 'streamit'),
					'default'     => esc_html__('Profile', 'streamit'),
				),

				array(
					'id'        => 'streamit_profile_link',
					'type'     => 'select',
					'multi'    => false,
					'data'     => 'pages',
					'title'     => esc_html__('Select Page For Profile', 'streamit'),
					'desc'      =>  esc_html__('Use [iqonic_user_profile] Shortcode on a page which you sleceted', 'streamit'),
				),

				array(
					'id'        => 'streamit_profile_icon',
					'type'     => 'select',
					'select2'  => array('containerCssClass' => 'fa'),
					'title'    => esc_html__('Profile button Icon', 'streamit'),
					'width'     => '100%',
					'class'    => ' font-icons',
					'options'  => $iconArray
				),
		...
		Redux::set_section($this->opt_name, array(
			...
			'fields' => array(
				array(
					...
					'type'      => 'button_set',
					'title'     => esc_html__('Show Follow Icon', 'streamit'),
					'subtitle' => esc_html__('Turn on to display the Social Icon', 'streamit'),
					'options'   => array(
				...
				array(
					...
					'type'      => 'button_set',
					'title'     => esc_html__('Show Like Icon', 'streamit'),
					'subtitle' => esc_html__('Turn on to display the Like Icon', 'streamit'),
					'options'   => array(
						'yes' => esc_html__('On', 'streamit'),
						'no' => esc_html__('Off', 'streamit')
					),
				...
				array(
					...
					'desc'      =>  esc_html__('Use [iqonic_user_watchlist] Shortcode on a page which you sleceted', 'streamit'),
				),

				array(
					'id'        => 'streamit_watchlist_icon',
					'type'     => 'select',
					'select2'  => array('containerCssClass' => 'fa'),
					'required'  => array('streamit_display_watchlist', '=', 'yes'),
					'title'    => esc_html__('Watchlist button Icon', 'streamit'),
					'width'     => '100%',
					'class'    => ' font-icons',
					'options'  => $iconArray
				),
		...
		Redux::set_section($this->opt_name, array(
			'title' => esc_html__('View all Settings', 'streamit'),
			'id'    => 'watch-options',
			'subsection' => true,
			'fields' => array(
				...
				array(
					...
					'multi'    => false,
					'data'     => 'pages',
					'title'    => __('Choose Terms&Conditons Page', 'streamit'),
					'subtitle' => __('Select Page that you want to display the terms and conditions', 'streamit'),
				),
				array(
					'id'        => 'streamit_viewall_text',
					'type'      => 'text',
					'title'     => esc_html__('View All button title', 'streamit'),
					'default'   => __('View All', 'streamit'),
				),
				array(
					'id'        => 'streamit_viewall_link',
					'type'     => 'select',
					'multi'    => false,
					'data'     => 'pages',
					'title'     => esc_html__('Select Page For View All', 'streamit'),
					'subtitle' => __('Select Page that you want to display the View All Data', 'streamit'),
				),

				array(
					'id'        => 'streamit_display_buttons',
					'type'      => 'button_set',
					'title'     => esc_html__('Viewall, Watchlist page Settings', 'streamit'),
				...
				array(
					'id'        => 'streamit_display_loadmore_text',
					'type'      => 'text',
					'title'     => esc_html__('Load More button text', 'streamit'),
					'default'   => esc_html__('Load More', 'streamit'),
					'required'  => array('streamit_display_buttons', '=', 'load_more'),
				),
				array(
					'id'        => 'streamit_display_loadmore_text_2',
					'type'      => 'text',
					'title'     => esc_html__('Load More button text', 'streamit'),
				...
				array(
					'id'        => 'streamit_post_per_page',
					'type'      => 'text',
					'title'     => esc_html__('Post Per Page', 'streamit'),
					'default'   => '12',
				),

				array(
					'id'        => 'streamit_display_order',
					'type'      => 'button_set',
					'title'     => esc_html__('Order By', 'streamit'),
					'options'   => array(
